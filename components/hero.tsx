      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <AnimateOnScroll>
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-teal-200/60 bg-teal-50/80 px-4 py-2 backdrop-blur-sm">
              <svg className="h-3.5 w-3.5 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
