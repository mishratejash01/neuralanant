...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-6 pb-32 pt-32 sm:pb-40 sm:pt-40">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        />
        {/* Subtle dark overlay to ensure the white text is highly readable */}
