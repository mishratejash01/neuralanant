  ...
  return (
    <div className="mb-24 w-full">
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <div 
          ref={scrollRef} 
          /* DESKTOP remains a pristine horizontal scroll track. MOBILE safely becomes a vertical stack. */
        ...
        >
          {/* Strictly keeping 3 items max per category as requested */}
          {members.slice(0, 3).map((member) => (
            <div 
              key={member.id} 
              /* ORIGINAL DESKTOP CLASSES PRESERVED. Mobile isolated using max-lg: prefix */
              className="group relative flex shrink-0 cursor-pointer overflow-hidden bg-[#eef5f5] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] hover:bg-[#e4ecec]
                h-[580px] w-[320px] p-10 transition-[width,background-color] hover:w-[850px]
                max-lg:h-[450px] max-lg:w-full max-lg:flex-col max-lg:p-6 max-lg:transition-[height,background-color] max-lg:hover:h-[800px] max-lg:hover:w-full"
            >
              ...
              <div className="flex h-full min-w-[240px] flex-col justify-between max-lg:items-center max-lg:text-center">
                ...
                <div className="mt-8 flex-1">
                  <h3 className="text-[2rem] font-medium leading-[1.1] text-black">
                    {/* Line break removed on mobile for cleaner stacking */}
                ...
                {/* Bottom Row: Social Icons & Arrow */}
                <div className="mt-4 flex w-full items-center pr-2 lg:justify-between max-lg:justify-center">
                  ...
                  {/* Mobile Down Arrow */}
                  <div className="block text-2xl text-black opacity-30 transition-opacity duration-300 group-hover:opacity-0 lg:hidden max-lg:ml-6">
                    &darr;
                  </div>
                </div>
              </div>
              ...
              <div className="flex min-w-[450px] flex-col justify-between opacity-0 transition-all duration-500 delay-200 group-hover:opacity-100
                ml-20 translate-x-10 group-hover:translate-x-0
                max-lg:ml-0 max-lg:mt-8 max-lg:min-w-full max-lg:-translate-x-0 max-lg:translate-y-10 max-lg:group-hover:translate-y-0 max-lg:items-center max-lg:text-center"
              >
                <div>
                ...
                <div className="flex flex-col gap-6 max-lg:mt-6 max-lg:items-center">
                  {member.member_type && (
